...
<!-- Developed by : Pranto Chakraborty. Senior Web Developer Mybdhost -->
<head>
      ...
      <div class="header-nav-wrapper navbar-scrolltofixed bg-silver-light">
        <div class="container">
          <nav id="menuzord-right" class="menuzord default no-bg">
            <a class="menuzord-brand pull-left flip" href="index-mp-layout1.html"><img src="{{asset('assets/images/logo-wide.png')}}" alt=""></a>
                  ...
                  <div class="megamenu-row">
                    ...
                    <div class="col5">
                      ...
                      <article class="post clearfix">
                        <div class="entry-header">
                          <div class="post-thumb"> <img class="img-fullwidth" src="{{asset('assets/images/blog/mega-menu.jpg')}}" alt=""> </div>
                        </div>
                    ...
                    <div class="col4">
                      ...
                      <div class="list-dashed">
                        <article class="post media-post clearfix pb-0 mb-10"> <a href="#" class="post-thumb"><img alt="" src="{{asset('assets/images/blog/square1.jpg')}}"></a>
                          <div class="post-right">
                            <h5 class="post-title mt-0"><a href="#">Bankruptcy Rights Proceedings</a></h5>
                            <p>Oct 23, 2015</p>
                          </div>
                        </article>
                        <article class="post media-post clearfix pb-0 mb-10"> <a href="#" class="post-thumb"><img alt="" src="{{asset('assets/images/blog/square2.jpg')}}"></a>
                          <div class="post-right">
                            <h5 class="post-title mt-0"><a href="#">Assertive and Persistent Advocacy</a></h5>
                            <p>Jun 23, 2015</p>
                          </div>
                        </article>
                        <article class="post media-post clearfix pb-0 mb-10"> <a href="#" class="post-thumb"><img alt="" src="{{asset('assets/images/blog/square3.jpg')}}"></a>
                          <div class="post-right">
      ...
      <div class="row border-bottom-black">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <a class="col-md-12 btn btn-colored text-white btn-flat btn-theme-colored mt-15 ajaxload-popup" href="ajax-load/donation-form.html" >Become a donor</a>
          </div>
        </div>
      </div>
     {{--  <div class="row mt-10">
